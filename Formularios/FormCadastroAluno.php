   ...
   <h1>Formulario do Aluno</h1>
		...
		<form action="index.php?pg=cadastroaluno" method="post">
			...
			<select name="UF" class="form-control col-md-6">
			...
			<div class="form-group col-md-6">
				<label>E-mail: </label>
				<input type="text" class="form-control" name="email" placeholder="Informe Seu E-mail" required />
			</div>

			<div class="form-group col-md-6">
				<label>Celular: </label>
				<input type="text" class="form-control" name="celular" placeholder="Informe seu Número" required />
			</div>

			<div class="form-group col-md-6">
				<label>Nascimento: </label>
				<input type="date" class="form-control" name="nascimento" placeholder="Informe sua Data de Nascimento" required />
			</div>
			
			<select name=" Qual seu nível de escolaridade" class="form-control col-md-6">

				<option> Qual seu nível de escolaridade? </opion>

				<option value="1">1ª do ensino médio</opion>

				<option value="2">2ª do ensino médio</opion>

				<option value="3">3ª do ensino médio</opion>

				<option value="completo">Ensino médio completo</opion>	
			...
			<div class="form-group col-md-6">
				<label>Curso: </label>
				<input type="text" class="form-control" name="curso" placeholder="Informe o seu Curso" required />
			</div>
			

			<select name="formado" class="form-control col-md-6">

				<option>Você é formado?</opion>

				<option value="sim">Sim</opion>

				<option value="nao">Não</opion>	

			</select>

			<div class="form-group col-md-6">
				<label>PDF do seu Currículo: </label>
				<input type="file" class="form-control" name="curriculo" placeholder="Anexe seu Currículo" required />
			</div>
