...
?>
	...
	<h1>Formulario da Escola</h1>
		...
		<form action="index.php?pg=atualizaempresa"  method="post">
		
		<input type="hidden" name="id" value="<?php echo $empresa->id?>">

			<div class="form-group col-md-6">
				<label> <strong>Nome * </strong> </label>
				<input type="text" class="form-control" name="nome" placeholder="Informe seu nome"  value="<?=$empresa->nome?>" required />
			...
			<div class="form-group col-md-6">
				...
				<input type="text" class="form-control" id="cnpj" name="cnpj" placeholder="Informe seu CNPJ"  value="<?=$empresa->cnpj?>"  />
			...
			<div class="form-group col-md-6">
				...
				<input type="text" class="form-control" id="cpf" name="cpf" placeholder="Informe seu CPF"  value="<?=$empresa->cpf?>" required />
			...
			<input type="email" class="form-control" name="email" placeholder="Informe Seu E-mail"  value="<?=$empresa->email?>" required />
			...
			<input type="text" class="form-control" name="segmento" placeholder="Qual seu Segmento"  value="<?=$empresa->segmento?>" required />
			...
			<input type="text" class="form-control" name="endereco" placeholder="Informe Seu Endereço"  value="<?=$empresa->endereco?>" required />
			...
			<input type="text" class="form-control" name="cidade" placeholder="Informe sua Cidade"  value="<?=$empresa->cidade?>" required />
			...
			<input type="text" class="form-control" name="bairro" placeholder="Informe Seu Bairro"  value="<?=$empresa->bairro?>" required />
			...
			<select name="uf" class="form-control">
				...
				<option value="<?=$empresa->uf?>"><?=$empresa->uf?> </opion>
			...
			<input type="text" class="form-control" name="telefone" placeholder="Informe seu telefone"  value="<?=$empresa->telefone?>" required />

			</div>

			<div class="form-group col-md-6">
				<label> <strong>Celular * </strong> </label>
			<input type="text" class="form-control" name="celular" placeholder="Informe seu Número"  value="<?=$empresa->celular?>" required />
			...
			<input type="text" class="form-control" name="observacoes"  value="<?=$empresa->observacoes?>" />

			</div>


			<select name="colaboradores"  value="<?=$escola->colaboradores?>" class="form-control col-md-6">

			<option value="<?=$empresa->colaboradores?>"><?=$empresa->colaboradores?> </opion>
