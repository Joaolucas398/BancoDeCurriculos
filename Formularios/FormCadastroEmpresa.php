 <h1>Formulario da Empresa</h1>
		...
		<form action="" method="post">
			...
			<div class="form-group col-md-6">
				<label>CNPJ: </label><br>
				<input type="text" class="form-control" name="cnpj" placeholder="Informe seu CNPJ" required />
			...
			<div class="form-group col-md-6">
				<label>CPF: </label><br>
				<input type="text" class="form-control" name="cpf" placeholder="Informe seu CPF" required />
			...
			<input type="text" class="form-control" name="Observacoes" placeholder=" " required />
